...
// agi-esp8266 demo webserver featuring ArduinoOTA
//  This version does not support a deep sleep function that will conserve battery power.
// Instead this standalone code connects to an MQTT broker, publishes the sensor data and
// hosts a webserver which also outputs the sensor data too.
...
const char* mqtt_server = "<IP ADDRESS HERE>"; // Change to your MQTT server
